...
// setInterval() permet de répéter la fonction fournie en premier argument selon un timer fourni en deuxieme argument (en milliseconde). Ici la fonction monAjax() toutes les 5 secondes
